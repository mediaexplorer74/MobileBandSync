...
// Type: MobileBandSync.Common.ObservableDictionary
...
namespace MobileBandSync.Common
{
    ...
    IEnumerable
  {
    ...
    public event MapChangedEventHandler<string, object> MapChanged
        {
            add => default;//EventRegistrationTokenTable<MapChangedEventHandler<string, object>>
                           //   .GetOrCreateEventRegistrationTokenTable(ref this.MapChanged).AddEventHandler(value);
            remove
            {
                //MapChangedEventHandler<string, object> U = this.MapChanged;
                //EventRegistrationTokenTable<MapChangedEventHandler<string, object>>
                //   .GetOrCreateEventRegistrationTokenTable(ref this.MapChanged).RemoveEventHandler(value);
        ...
        {
           // EventRegistrationTokenTable<MapChangedEventHandler<string, object>>
           //     .GetOrCreateEventRegistrationTokenTable(ref this.MapChanged).InvocationList?.Invoke((IObservableMap<string, object>)this, (IMapChangedEventArgs<string>)new ObservableDictionary.ObservableDictionaryChangedEventArgs(change, key));
        }
