...
// Type: MobileBandSync.OpenTcx.Entities.CustomSpeedZone_t
...
namespace MobileBandSync.OpenTcx.Entities
{
  ...
  public class CustomSpeedZone_t : Zone_t
  {
    ...
    public SpeedType_t ViewAs
    {
      ...
      set => this.viewAsField = value;
    }

    public double LowInMetersPerSecond
    {
      get => this.lowInMetersPerSecondField;
      set => this.lowInMetersPerSecondField = value;
    }

    public double HighInMetersPerSecond
    {
      get => this.highInMetersPerSecondField;
      set => this.highInMetersPerSecondField = value;
    }
  }
}
